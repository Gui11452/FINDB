(function(){
    ...
    const checkboxVideo = document.querySelector('#checkbox-video');
    ...
    const errorFoto = document.querySelector('#error_foto');
    const errorVideo = document.querySelector('#error_video');
    ...
    document.addEventListener('input', e => {
        ...
        // Video
        if(el == checkboxVideo && checkboxVideo.checked){
            video.classList.add('selecionado');
        } else if(el == checkboxVideo && !checkboxVideo.checked){
            video.classList.remove('selecionado');
        }
    ...
    document.addEventListener('submit', e => {
        ...
        if(checkboxFoto.checked && !foto.value){
            validador = false;
            errorFoto.innerHTML = 'Se você selecionou o campo acima, ele NÃO pode ficar vazio.';
        }

        if(checkboxVideo.checked && !video.value){
            validador = false;
            errorVideo.innerHTML = 'Se você selecionou o campo acima, ele NÃO pode ficar vazio.';
        }
